...
local MinimapIcons = { "Note", "JQuest", "Naut_", "MinimapIcon", "GatherMatePin", "WestPointer", "Chinchilla_", "SmartMinimapZoom","QuestieNote", "smm", "FishingExtra","pfMiniMapPin","Spy_","WIM","MinimapClock", "Clock", "WIM_IconFrameButton", "RecipeRadarMinimapButton", "AtlasButton", "DifficultBulletinBoard_MinimapButtonFrame", "TZC"};
